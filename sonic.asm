...
Title_Local:	dc.b "REIMU THE SHRINE MAIDEN IN SONIC THE HEDGEHOG   " ; Domestic name
Title_Int:	dc.b "REIMU THE SHRINE MAIDEN IN SONIC THE HEDGEHOG   " ; International name
...
M_Got_SonicHas:	dc.b 8	;  SONIC HAS | REIMU HAS
		dc.b $F8, 5, 0, $3A, $B4	; R
		dc.b $F8, 5, 0, $10, $C4	; E
		dc.b $F8, 1, 0, $20, $D4	; I
		dc.b $F8, 5, 0, $2A, $DC	; M
